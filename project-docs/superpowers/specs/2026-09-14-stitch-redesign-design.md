...
Create `project-docs/` at project root:
...
- Export Stitch design tokens to `project-docs/design/design-system.md`
...
2. Extract current design system to `project-docs/design/current-state.md`
...
- [ ] Complete documentation in `project-docs/`
