...
export default function CTASection({
  ...
  return (
    <section className={cn('mx-auto max-w-7xl px-6 py-20', className)}>
      <div className={cn('relative overflow-hidden rounded-2xl', bg, 'p-8 lg:p-12 shadow-lg')}>
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div className="max-w-xl space-y-3">
            {badge && (
              <div
                className={cn(
                  'inline-flex items-center gap-1.5 text-xs uppercase tracking-wider font-bold',
